...
public AddMapicons(playerid)
{
	...
	SetPlayerMapIcon(playerid, 29, 1434.27, 365.70, 18.50, E_MAPICON_ID_PROPERTY_NOT_FOR_SALE, 0, MAPICON_LOCAL);
	SetPlayerMapIcon(playerid, 30, -2068.49, -2544.05, 30.25, E_MAPICON_ID_PROPERTY_NOT_FOR_SALE, 0, MAPICON_LOCAL);

	SetPlayerMapIcon(playerid, 23, -2686.03, 205.63, 3.96, E_MAPICON_ID_PROPERTY_FOR_SALE, 0, MAPICON_LOCAL);
	SetPlayerMapIcon(playerid, 24, -1497.76, 2671.87, 55.25, E_MAPICON_ID_PROPERTY_FOR_SALE, 0, MAPICON_LOCAL);
	SetPlayerMapIcon(playerid, 25, 756.10, 332.78, 19.99, E_MAPICON_ID_PROPERTY_FOR_SALE, 0, MAPICON_LOCAL);
	SetPlayerMapIcon(playerid, 26, 730.69, -538.99, 16.33, E_MAPICON_ID_PROPERTY_FOR_SALE, 0, MAPICON_LOCAL);
	SetPlayerMapIcon(playerid, 27, -2803.74, -127.57, 6.84, E_MAPICON_ID_PROPERTY_FOR_SALE, 0, MAPICON_LOCAL);
	SetPlayerMapIcon(playerid, 28, 248.99, -294.65, 1.34, E_MAPICON_ID_PROPERTY_FOR_SALE, 0, MAPICON_LOCAL);
