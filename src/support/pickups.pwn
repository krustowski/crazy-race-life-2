...
public InitPickups()
{
	...
	// Bank LS
	gPickupBankLSExit = CreatePickup(1318, 1, 1484.13, -1778.76, 6.70);
	gPickupBankLSEnter = CreatePickup(1318, 1, 1481.20, -1770.62, 18.80);
 	//CreatePickup(1274,1,1470.34,-1806.61,6.70); //bankomat

 	// Centrum SF
 	gPickupSFCentrumExit = CreatePickup(1318, 1, -1903.26, 486.28, 21.93); 
 	gPickupSFCentrumEnter = CreatePickup(1318, 1, -1899.01, 486.52, 35.17);
