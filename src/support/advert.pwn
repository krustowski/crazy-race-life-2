...
public ShowAdvert()
{
	new advertList[][] =
	{
		...
		"[ TIP ] You can attach a vehicle to your property using /property item",
		"[ TIP ] Bored of Las Venturas Pyramid spawn point? Buy a property and respawn there instead using /property",
		// Endtip.
