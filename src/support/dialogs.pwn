...
enum
{
	DIALOG_PROPERTY_BUY = 0x10,
	DIALOG_PROPERTY_RENT,
...
enum
{
	DIALOG_HIGH_SCORES_OPTIONS = 0x40,
...
enum
{
	DIALOG_PLAYER_CLICKED_LIST = 0x90,
...
stock ShowPortListDialog(playerid)
{
	...
	format(portList, sizeof(portList), "%s\n%s\n%s\n%s\n%s",
			...
			"San Fierro WangCars",
			"Los Santos Airport",
			"San Fierro Ship Parkour",
			"Bone County Parkour (experimental)"
			//"Combat #2 (experimental)"
		);
